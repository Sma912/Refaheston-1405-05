    ...
    <div className="space-y-3 rounded-2xl border border-blue-200 bg-blue-50/60 p-4">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600">
          همگام‌سازی خودکار فعال است: وقتی لیست با 📱 و 💰 در کانال پست شود، چند ثانیه بعد
          روی سایت می‌نشیند. یک کرون ساعتی هم بافرهای گیرکرده را جمع می‌کند و وب‌هوک را
          سلامت‌سنجی می‌کند. بازو باید ادمین کانال باشد.
        </p>
      </div>
