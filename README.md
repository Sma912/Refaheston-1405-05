...
1. ورود با OTP بله
2. افزودن به سبد و Checkout
3. وضعیت اولیه: `pending_confirmation`
4. پیام ثابت پس از ثبت: تأیید موجودی و فعال‌سازی پرداخت از طریق بله
5. ادمین در `/admin/orders` وضعیت و یادداشت را تغییر می‌دهد
